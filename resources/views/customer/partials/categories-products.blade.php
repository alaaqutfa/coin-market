    ...
    <div class="category-section mb-12">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-6">
            @foreach ($category->products as $product)
                ...
                <div class="group bg-white rounded-xl shadow-md border border-gray-200 hover:shadow-xl hover:-translate-y-1 transition-all duration-300 overflow-hidden">
                    <!-- صورة المنتج -->
                    ...
                    <div class="p-4">
                        <a href="{{ $productLink }}" class="block">
                            <h3 class="font-semibold text-gray-800 text-lg mb-2 group-hover:text-yellow-600 transition-colors duration-200 line-clamp-2" title="{{ $product->name }}">
                                {{ $product->name }}
                            </h3>
                        </a>
