            ...
            <form id="filter-form" class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-4">
                ...
                <div>
                    ...
                    <select name="category" id="category"
                        class="text-gray-800 bg-white/10 backdrop-blur-sm border border-white/20 text-sm rounded-lg focus:ring-2 focus:ring-yellow-500 focus:border-yellow-500 block w-full p-3">
