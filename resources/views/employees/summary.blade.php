...
@section('content')
    <div class="container mx-auto px-4 py-8">
        ...
        <div class="bg-gradient-to-r from-yellow-400 to-yellow-500 rounded-2xl shadow-lg p-6 mb-8">
            <div class="flex flex-col md:flex-row justify-between items-center">
                <div class="text-white">
                    ...
                    <p class="text-yellow-100 mt-2">📅 {{ $data['current_month'] ?? now('Asia/Beirut')->translatedFormat('F Y') }}</p>
                </div>
        ...
        <div class="bg-white rounded-xl shadow-lg p-6 mb-8">
            ...
            <form method="GET" action="{{ route('employee.all') }}" id="employeeForm">
                <div class="relative">
                    <select name="employee_id" id="employeeSelect" class="employee-select" onchange="document.getElementById('employeeForm').submit()">
            ...
            <div id="employeeData">
                    ...
                    <div class="stat-card bg-white rounded-xl shadow-md border-l-4 border-yellow-400 p-6">
                        <div class="flex items-center justify-between">
                            <div>
                                ...
                                <p class="text-3xl font-bold text-gray-800 mt-2">{{ $data['summary']['attendance_days'] }}</p>
                            </div>
                    ...
                    <div class="stat-card bg-white rounded-xl shadow-md border-l-4 border-green-400 p-6">
                        <div class="flex items-center justify-between">
                            <div>
                                ...
                                <p class="text-3xl font-bold text-gray-800 mt-2">{{ $data['summary']['total_actual_hours'] }}</p>
                            </div>
                    ...
                    <div class="stat-card bg-white rounded-xl shadow-md border-l-4 border-blue-400 p-6">
                        <div class="flex items-center justify-between">
                            <div>
                                ...
                                <p class="text-3xl font-bold text-gray-800 mt-2">{{ $data['summary']['total_required_hours'] }}</p>
                            </div>
                ...
                <div class="bg-white rounded-xl shadow-lg p-6 mb-8">
                    <div class="flex justify-between items-center mb-4">
                        ...
                        <span class="text-2xl font-bold text-yellow-600">{{ $data['summary']['achievement_rate'] }}%</span>
                    </div>
                                ...
                                <div class="border border-gray-200 rounded-lg p-4 hover:bg-gray-50 transition-colors">
                                    <div class="flex justify-between items-center mb-2">
                                        <div class="flex items-center">
                                            <span class="font-bold text-gray-800 ml-2">{{ $record['formatted_date'] }}</span>
                                            <span class="text-sm text-gray-600">{{ $record['day_name'] }}</span>
                                        </div>
                                        <span class="attendance-badge rounded-full px-3 py-1 text-xs font-medium
                ...
                <div class="mt-8 text-center text-gray-600">
                    <p>فترة التقرير: من {{ \Carbon\Carbon::parse($data['period']['start_date'])->format('d/m/Y') }} إلى {{ \Carbon\Carbon::parse($data['period']['end_date'])->format('d/m/Y') }}</p>
                </div>
            </div>
